        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Track your active skill goals, scheduled sessions, and milestone progress.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {!learnerData?.skillGoals || learnerData.skillGoals.length === 0 ? (
            <div className="p-8 text-center glass-card rounded-2xl border border-emerald-500/10">
              <p className="text-xs text-slate-400">No skill goals defined yet. Explore mentors to select target goals!</p>
            </div>
          ) : (
            <div className="space-y-4">
              {learnerData.skillGoals.map((goal) => {
                ...
                return (
                  <div key={goal.id} className="p-6 rounded-2xl glass-card border border-emerald-500/20 space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
          ...
          {!learnerData?.learnerSessions || learnerData.learnerSessions.length === 0 ? (
            ...
            <div className="space-y-3">
              {learnerData.learnerSessions.map((session) => (
                <div key={session.id} className="p-4 rounded-2xl glass-card border border-emerald-500/20 space-y-2">
                  <div className="flex items-center justify-between">
